...
<div id="wrapper"> 
    ...
    <div id="header">
        ...
        <div class="logo"><img src="foto_banner/purwokertocampshop.jpg" /></div>
	...
	?>
      ...
      while($a=mysql_fetch_array($best)){
        ...
        <div class="latest-product ">
			...
			<img src="template/images/bca.png" />
			<img src="template/images/bni.jpg" />
			<img src="template/images/bri.png" />
...
<div class="plugin">             
    ...
    <div class="page">
        ...
        <div class="copyright">
              <ul>
            <li>&copy; 2016 </li>
            <li><a href="#" class="select">purwokertocampshop</a> All Rights Reserved.</li>
